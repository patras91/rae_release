...
def ResetState():
    state.loc = {'r1': 'base', 'UAV': 'base',  'r2d2': 'base', 'bb8': 'base'}
    state.charge = {'r1':75, 'UAV': 75, 'r2d2': 100, 'bb8': 50}
    state.data = {'r1': 0, 'UAV': 0, 'r2d2': 0, 'bb8': 0}
    state.load = {'r1': NIL, 'UAV': NIL, 'r2d2': NIL, 'bb8': NIL}
