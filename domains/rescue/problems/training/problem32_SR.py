...
def ResetState():
    state.loc = {'w1': (16,19), 'w2': (21,8), 'p1': (19,25), 'a1': (20,15)}
    state.hasMedicine = {'a1': 0, 'w1': 0, 'w2': 0}
    state.robotType = {'w1': 'wheeled', 'a1': 'uav', 'w2': 'wheeled'}
    state.status = {'w1': 'free', 'w2': 'free', 'a1': UNK, 'p1': UNK, (19,25): UNK}
    state.altitude = {'a1': 'high'}
    state.currentImage = {'a1': None}
    state.realStatus = {'w1': 'OK', 'p1': 'injured', 'w2': 'OK', 'a1': OK, (19, 25): 'clear'}
    state.realPerson = {(19,25): 'p1'}
    state.newRobot = {1: None}
    state.weather = {(19,25): "clear"}
