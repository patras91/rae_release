...
rae1.declare_prob(openDoor, [0.8, 0.2])
...
rae1.declare_prob(passDoor, [0.8, 0.2])
...
rae1.declare_prob(holdDoor, [0.8, 0.2])
...
rae1.declare_prob(releaseDoor, [1])
...
rae1.declare_prob(move, [0.8, 0.2])
...
rae1.declare_prob(closeDoors, [1])
