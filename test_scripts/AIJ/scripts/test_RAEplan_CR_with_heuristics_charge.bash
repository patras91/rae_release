...
do
            ...
            fname="../results/${domain}_v_journal/rae_plan_b_${b}_k_${k}_d_${d}_h_h3.txt" # You should have a folder called CR in the current folder
