...
do
            echo $domain $problem "b = " $b ", k = " $k ", d = " $d ", Run " $counter/$runs
            time_test="testBatch(domain='$domain', problem='$problem', useRAEplan=True)"

            fname="../../results/${domain}_v_journal/rae_plan_b_${b}_k_${k}_d_${d}_h_h1.txt" # You should have a folder called CR in the current folder
