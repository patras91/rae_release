...
rv.EDGES = {1: [2], 2: [1, 3], 3: [2, 4], 4: [3, 5, 7], 5: [4, 6], 6: [5, 7], 7: [6, 4]}
rv.DOORLOCATIONS = {(6, 7): 'd1', (4, 7): 'd2', (5, 6): 'd3', (2, 3): 'd4', (1, 2): 'd5', (3, 4): 'd6'}
rv.ROBOTS = ['r1', 'r2', 'r3']
...
def ResetState():
    ...
    state.loc = {'r1': 2, 'r2': 5, 'r3': 3}
    state.pos = {'o1': 3, 'o2': 2, 'o3': 5}
    state.done = {0: False}
