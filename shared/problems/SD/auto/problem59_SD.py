...
rv.EDGES = {1: [2, 5], 2: [1, 3, 4], 3: [2], 4: [2, 6, 7], 5: [1], 6: [4], 7: [4]}
rv.DOORLOCATIONS = {(1, 5): 'd1', (2, 4): 'd2', (4, 7): 'd5', (4, 6): 'd4'}
rv.ROBOTS = ['r1', 'r2', 'r3']
rv.DOORS = ['d1', 'd2', 'd3', 'd4', 'd5']
rv.DOORTYPES = {'d1': 'ordinary', 'd2': 'ordinary', 'd3': 'ordinary', 'd4': 'ordinary', 'd5': 'spring'}

def ResetState():
    state.load = {'r1': NIL, 'r2': NIL, 'r3': NIL}
    state.doorStatus = {'d1': 'closed', 'd2': 'closed', 'd3': 'closed', 'd4': 'closed', 'd5': 'closed'}
    state.loc = {'r1': 2, 'r2': 4, 'r3': 2}
    state.pos = {'o1': 5, 'o2': 2, 'o3': 2}
    state.done = {0: False}
