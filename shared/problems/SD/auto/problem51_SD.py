...
rv.EDGES = {1: [2, 4], 2: [1, 3], 3: [2, 5], 4: [1], 5: [3, 6, 7], 6: [5], 7: [5, 8], 8: [7]}
rv.DOORLOCATIONS = {(1, 2): 'd5', (5, 7): 'd3', (3, 5): 'd4'}
rv.ROBOTS = ['r1', 'r2']
rv.DOORS = ['d1', 'd2', 'd3', 'd4', 'd5']
rv.DOORTYPES = {'d1': 'ordinary', 'd2': 'spring', 'd3': 'ordinary', 'd4': 'ordinary', 'd5': 'spring'}
