...
# input|     |p1   |pck1 |
#   1  |  2  |  3  |  4  |
#______|_____|__r3_|___r2|
#      |     |     |     |
#      |  5  |  6  |  7  |
#      |___r1|_____|___w1|______
#      |     |     |     |output
#      |  8  |  9  |  10 |  11
#      |___a1|___p2|_____|______
# Tests when r1 is at a slippery location, we should get better performance with higher value of k
...
def ResetState():
    ...
    state.deliveryRobot = {0: None}
tasks = {
    2: [['order', ['paint', 'o1', 'white']]],
}
