...
#      |p1   |     |     |
#      |  5  |  6  |  7  |
#      |___r2|____ |___w1|______
#      |     |     |     |output
#      |  8  |  9  |  10 |  11
#      |___a1|r3_p2|_____|______
...
def ResetState():
    ...
    state.loc = {'r1': 2, 'r2': 5, 'r3': 9}
    state.status = {'r1': 'free', 'r2': 'free', 'r3': 'free', 'p1': 'free', 'a1': 'free', 'pck1': 'free', 'p2': 'free', 'w1': 'free'}
    state.pos = {'a': rv.BUFFERS['input'], 'b': rv.BUFFERS['input'], 'c': rv.BUFFERS['input'], 'o1': rv.BUFFERS['input'], 'o2': rv.BUFFERS['input'], 'gift': rv.BUFFERS['input']}
