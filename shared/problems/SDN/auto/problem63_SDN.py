...
tasks = {
    ...
    4: [['fix_component', 'switch47', secmgr_config, 'A number of components are low on resources, including switch47']],
    5: [['fix_component', 'switch49', secmgr_config, 'A number of components are low on resources, including switch49']]
}
