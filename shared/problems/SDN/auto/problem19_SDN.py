...
tasks = {
    ...
    5: [['fix_component', 'switch43', secmgr_config, 'A number of components are low on resources, including switch43']],
    6: [['fix_component', 'switch47', secmgr_config, 'A number of components are low on resources, including switch47']]
}
