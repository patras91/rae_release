...
tasks = {
    ...
    4: [['fix_component', 'switch35', secmgr_config, 'A number of components are low on resources, including switch35']],
    5: [['fix_component', 'switch40', secmgr_config, 'A number of components are low on resources, including switch40']],
    6: [['fix_component', 'switch43', secmgr_config, 'A number of components are low on resources, including switch43']]
}
