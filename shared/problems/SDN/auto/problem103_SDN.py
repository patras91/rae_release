...
tasks = {
    ...
    3: [['fix_component', 'switch12', secmgr_config, 'A number of components are low on resources, including switch12']],
    ...
    7: [['fix_component', 'switch32', secmgr_config, 'A number of components are low on resources, including switch32']],
    8: [['fix_component', 'switch34', secmgr_config, 'A number of components are low on resources, including switch34']],
