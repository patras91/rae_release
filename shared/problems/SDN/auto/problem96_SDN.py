...
tasks = {
    ...
    6: [['fix_component', 'switch27', secmgr_config, 'A number of components are low on resources, including switch27']],
    7: [['fix_component', 'switch37', secmgr_config, 'A number of components are low on resources, including switch37']],
    8: [['fix_component', 'switch38', secmgr_config, 'A number of components are low on resources, including switch38']],
    9: [['fix_component', 'switch40', secmgr_config, 'A number of components are low on resources, including switch40']],
    10: [['fix_component', 'switch45', secmgr_config, 'A number of components are low on resources, including switch45']]
}
