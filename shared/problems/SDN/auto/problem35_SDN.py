...
tasks = {
    ...
    6: [['fix_component', 'switch21', secmgr_config, 'A number of components are low on resources, including switch21']],
    7: [['fix_component', 'switch25', secmgr_config, 'A number of components are low on resources, including switch25']],
    ...
    11: [['fix_component', 'switch43', secmgr_config, 'A number of components are low on resources, including switch43']]
}
