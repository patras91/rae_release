...
tasks = {
    ...
    4: [['fix_component', 'switch10', secmgr_config, 'A number of components are low on resources, including switch10']],
    5: [['fix_component', 'switch11', secmgr_config, 'A number of components are low on resources, including switch11']],
    6: [['fix_component', 'switch23', secmgr_config, 'A number of components are low on resources, including switch23']],
    7: [['fix_component', 'switch31', secmgr_config, 'A number of components are low on resources, including switch31']],
    8: [['fix_component', 'switch35', secmgr_config, 'A number of components are low on resources, including switch35']],
    9: [['fix_component', 'switch36', secmgr_config, 'A number of components are low on resources, including switch36']],
